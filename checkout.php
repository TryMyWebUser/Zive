...
<!-- Mirrored from themezhub.net/kumo-new-update/kumo/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Jun 2025 11:23:42 GMT -->
<head>
		<meta charset="utf-8" />
				...
				<div class="container">
					...
					<div class="row justify-content-between">
										...
										<div class="panel-group pay_opy980" id="payaccordion">
											...
											<div class="panel panel-default border">
												<div class="panel-heading" id="pay">
													<h4 class="panel-title">
														<a data-bs-toggle="collapse" role="button" data-parent="#payaccordion" href="#payPal" aria-expanded="true"  aria-controls="payPal" class="">PayPal<img src="assets/img/paypal.html" class="img-fluid" alt=""></a>
													</h4>
												</div>
											...
											<div class="panel panel-default border">
												<div class="panel-heading" id="stripes">
													<h4 class="panel-title">
														<a data-bs-toggle="collapse" role="button" data-parent="#payaccordion" href="#stripePay" aria-expanded="false"  aria-controls="stripePay" class="">Stripe<img src="assets/img/strip.html" class="img-fluid" alt=""></a>
													</h4>
												</div>
											...
											<div class="panel panel-default border">
												<div class="panel-heading" id="dabit">
													<h4 class="panel-title">
														<a data-bs-toggle="collapse" href="#payaccordion" data-bs-target="#debitPay" aria-expanded="false"  aria-controls="debitPay" class="">Debit Or Credit<img src="assets/img/debit.html" class="img-fluid" alt=""></a>
													</h4>
												</div>
						...
						<div class="col-12 col-lg-4 col-md-12">
							...
							<a class="btn btn-block btn-dark w-100 mb-3" href="checkout.html">Place Your Order</a>
						</div>
						...
						<div class="row">
							...
							<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
								<div class="footer_widget">
									<img src="assets/img/footer-logo.png" class="img-footer small mb-2" alt="" />
...
<!-- Mirrored from themezhub.net/kumo-new-update/kumo/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Jun 2025 11:23:43 GMT -->
</html>